...
| Deep Human Expertise & Niche Subcultures Brainstorm | Agentic Ideation | yes | Broad expansion pass: 9 disciplines added spanning performance arts (magic, circus), specialized crafts (lutherie, theme park design, combatives), digital edge-cases (speedrunning, trust & safety), and operational lore (esoteric systems, clandestine tradecraft) |
